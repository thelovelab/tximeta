...
```
    ...
    ## loading existing TxDb created: 2026-03-03 22:27:25
...
```
    ...
    ## loading existing gene ranges created: 2026-03-03 22:27:28
...
```
    ...
    ##   ..$ : int [1:3] 1 29 9
    ##  $ type      : chr "salmon"
    ##  $ importTime: POSIXct[1:1], format: "2026-03-03 22:27:17"
...
```
    ...
    ## writing linkedTxome to /tmp/Rtmpxgy1dW/Dm.BDGP6.22.98.plus_salmon-0.14.1.json
...
```
    ...
    ## 1 BFC1  link… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 2 BFC2  Dros… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 3 BFC3  txpR… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 4 BFC4  exon… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 5 BFC5  gene… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 6 BFC6  genc… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 7 BFC7  txpR… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 8 BFC8  Dros… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 9 BFC9  txpR… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
...
```
    ...
    ##   rid   rname create_time access_time rpath rtype fpath last_modified_time etag 
    ##   <chr> <chr> <chr>       <chr>       <chr> <chr> <chr>              <dbl> <chr>
    ## 1 BFC2  Dros… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 2 BFC3  txpR… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 3 BFC4  exon… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 4 BFC5  gene… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 5 BFC6  genc… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 6 BFC7  txpR… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 7 BFC8  Dros… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 8 BFC9  txpR… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## # ℹ 1 more variable: expires <dbl>
...
```
    ...
    ## found matching linkedTxome:
    ## [ LocalEnsembl - Drosophila melanogaster - release 98 ]
    ## loading existing TxDb created: 2026-03-03 22:29:06
    ## loading existing transcript ranges created: 2026-03-03 22:29:07
...
```
    ...
    ## 7 BFC8  Dros… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 8 BFC9  txpR… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## 9 BFC10 link… 2026-03-03… 2026-03-03… /tmp… rela… 1996…                 NA NA   
    ## # ℹ 1 more variable: expires <dbl>
...
```
    ...
    ##  biomaRt                2.67.3     2026-02-22 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  edgeR                * 4.9.4      2026-03-02 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  pkgdown                2.2.0.9000 2026-03-03 [1] Github (r-lib/pkgdown@a6abe43)
    ...
    ##  tximeta              * 1.29.9     2026-03-03 [1] Bioconductor

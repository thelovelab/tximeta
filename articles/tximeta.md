...
```
    ...
    ## loading existing TxDb created: 2025-11-14 18:46:58
...
begin a differential expression analysis.
...
We have a convenient wrapper function that will build a *DGEList* object
for use with *edgeR*.
...
```
    ...
    ## loading existing gene ranges created: 2025-11-14 18:47:02
...
```
    ...
    ##   ..$ : int [1:3] 1 27 19
    ##  $ type      : chr "salmon"
    ##  $ importTime: POSIXct[1:1], format: "2025-11-14 18:46:49"
...
et al. 2025) quantification tools allows specifying distinct *annotated*
reference transcripts (e.g. GENCODE, Ensembl) and *novel* reference
transcripts (e.g. *de novo* assemblies) which are combined together as
the index for alignment and quantification.

For example, indexing and quantification could be accomplished with:

    oarfish --only-index --annotated gencode.v48.transcripts.fa.gz --novel my_novel_txps.fa.gz --seq-tech ont-cdna --threads 32 --index-out gencode_plus_novel
    oarfish --reads reads/experiment_rep1.fastq.gz --index gencode_plus_novel --output quants/experiment_rep1 --seq-tech ont-cdna --filter-group no-filters --threads 32

Here we introduce a new workflow for importing data and linking data to
metadata, designed for this mixed reference transcript situation, but
which may be generalized in the future for other transcript
...
```
    ...
    ##                         <character> <integer>            <list> <character>
...
```
    ...
    ## writing linkedTxome to /tmp/Rtmpjiad9x/Dm.BDGP6.22.98.plus_salmon-0.14.1.json
...
```
    ...
    ## 1 BFC1  link… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 2 BFC2  Dros… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 3 BFC3  txpR… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 4 BFC4  exon… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 5 BFC5  gene… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 6 BFC6  genc… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 7 BFC7  txpR… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 8 BFC8  Dros… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 9 BFC9  txpR… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
...
```
    ...
    ##   rid   rname create_time access_time rpath rtype fpath last_modified_time etag 
    ##   <chr> <chr> <chr>       <chr>       <chr> <chr> <chr>              <dbl> <chr>
    ## 1 BFC2  Dros… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 2 BFC3  txpR… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 3 BFC4  exon… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 4 BFC5  gene… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 5 BFC6  genc… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 6 BFC7  txpR… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 7 BFC8  Dros… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 8 BFC9  txpR… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## # ℹ 1 more variable: expires <dbl>
...
```
    ...
    ## found matching linkedTxome:
    ## [ LocalEnsembl - Drosophila melanogaster - release 98 ]
    ## loading existing TxDb created: 2025-11-14 18:48:47
    ## loading existing transcript ranges created: 2025-11-14 18:48:48
...
```
    ...
    ## 7 BFC8  Dros… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 8 BFC9  txpR… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## 9 BFC10 link… 2025-11-14… 2025-11-14… /tmp… rela… 18c9…                 NA NA   
    ## # ℹ 1 more variable: expires <dbl>
...
```
    ...
    ## ─ Session info ───────────────────────────────────────────────────────────────
    ##  setting  value
    ##  version  R Under development (unstable) (2025-11-06 r88990)
    ...
    ##  biomaRt                2.67.0     2025-10-31 [1] Bioconductor 3.23 (R 4.6.0)
    ##  Biostrings             2.79.2     2025-11-05 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  digest                 0.6.38     2025-11-12 [2] CRAN (R 4.6.0)
    ##  dplyr                  1.1.4      2023-11-17 [1] CRAN (R 4.6.0)
    ##  edgeR                * 4.9.0      2025-10-30 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  GenomeInfoDb           1.47.0     2025-10-31 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  GenomicRanges        * 1.63.0     2025-10-31 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  KEGGREST               1.51.0     2025-10-31 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  remotes                2.5.0      2024-03-17 [1] CRAN (R 4.6.0)
    ...
    ##  RSQLite                2.4.4      2025-11-10 [1] CRAN (R 4.6.0)
    ##  rtracklayer            1.71.0     2025-11-04 [1] Bioconductor 3.23 (R 4.6.0)
    ##  S4Arrays               1.11.0     2025-10-31 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  SparseArray            1.11.1     2025-10-31 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  txdbmaker              1.7.1      2025-11-04 [1] Bioconductor 3.23 (R 4.6.0)
    ##  tximeta              * 1.27.19    2025-11-14 [1] Bioconductor
    ##  tximport               1.39.1     2025-11-06 [1] Bioconductor 3.23 (R 4.6.0)
    ##  UCSC.utils             1.7.0      2025-10-30 [1] Bioconductor 3.23 (R 4.6.0)
    ...
    ##  yaml                   2.3.10     2024-07-26 [2] CRAN (R 4.6.0)
    ## 
    ##  [1] /__w/_temp/Library

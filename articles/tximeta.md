...
```
    ...
    ## loading existing TxDb created: 2025-12-19 15:49:59
...
```
    ...
    ## loading existing gene ranges created: 2025-12-19 15:50:02
...
```
    ...
    ##   ..$ : int [1:3] 1 29 4
    ##  $ type      : chr "salmon"
    ##  $ importTime: POSIXct[1:1], format: "2025-12-19 15:49:51"
...
```
    ...
    ## writing linkedTxome to /tmp/RtmpIcdksb/Dm.BDGP6.22.98.plus_salmon-0.14.1.json
...
```
    ...
    ## 1 BFC1  link… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 2 BFC2  Dros… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 3 BFC3  txpR… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 4 BFC4  exon… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 5 BFC5  gene… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 6 BFC6  genc… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 7 BFC7  txpR… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 8 BFC8  Dros… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 9 BFC9  txpR… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
...
```
    ...
    ##   rid   rname create_time access_time rpath rtype fpath last_modified_time etag 
    ##   <chr> <chr> <chr>       <chr>       <chr> <chr> <chr>              <dbl> <chr>
    ## 1 BFC2  Dros… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 2 BFC3  txpR… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 3 BFC4  exon… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 4 BFC5  gene… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 5 BFC6  genc… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 6 BFC7  txpR… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 7 BFC8  Dros… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 8 BFC9  txpR… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## # ℹ 1 more variable: expires <dbl>
...
```
    ...
    ## found matching linkedTxome:
    ## [ LocalEnsembl - Drosophila melanogaster - release 98 ]
    ## loading existing TxDb created: 2025-12-19 15:51:37
    ## loading existing transcript ranges created: 2025-12-19 15:51:37
...
```
    ...
    ## 7 BFC8  Dros… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 8 BFC9  txpR… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## 9 BFC10 link… 2025-12-19… 2025-12-19… /tmp… rela… 1625…                 NA NA   
    ## # ℹ 1 more variable: expires <dbl>
...
```
    ...
    ## ─ Session info ───────────────────────────────────────────────────────────────
    ##  setting  value
    ##  version  R Under development (unstable) (2025-12-13 r89166)
    ...
    ##  pkgdown                2.2.0.9000 2025-12-19 [1] Github (r-lib/pkgdown@c07d935)
    ...
    ##  tximeta              * 1.29.4     2025-12-19 [1] Bioconductor

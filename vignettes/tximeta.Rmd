...
packages [@granges] to parse the GTF and build a *TxDb*. For Ensembl
...
An alternative workflow is to wrap other quantifiers in workflows
...
package. The correct digest is the SHA-256 hash value of the reference
sequences stripped of the sequence ID, concatenated
together. *FastaDigest* can be installed with 

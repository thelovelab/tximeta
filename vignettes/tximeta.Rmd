...
for use with *edgeR* (for example of generating an object for running
*limma*, see details in the *tximport* vignette).
...
* Building out actual, sustainable plan for supporting as many
  organisms and sources as possible. Ongoing discussions between the
  `tximeta` developers and GA4GH/`refget` may provide a sustainable
  solution. 
